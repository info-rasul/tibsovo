import stomachIcon from '../sixth/Health, Medicine/stomach.svg'
import groupIcon from '../sixth/Health, Medicine/Group.svg'
import groupIcon2 from '../sixth/Health, Medicine/Health, Medicine/Group.svg'
  ...
  return (
    <section className="relative w-full flex flex-col items-stretch justify-start bg-white py-12 md:py-16 overflow-hidden">
      ...
      <div className="w-full max-w-[1360px] mx-auto flex flex-col items-stretch justify-start">
        ...
        <div className="w-full flex flex-col items-stretch justify-start" style={{ fontFamily: 'Geist, -apple-system, Roboto, Helvetica, sans-serif' }}>
          {/* Заголовок секции */}
          ...
          <div className="mt-4 w-full max-w-[1243px] flex flex-col items-stretch justify-start">
            ...
            <h3 className="text-[#61279E] text-[28px] md:text-[40px] font-semibold leading-[44px] tracking-[-1.2px]">
              Терапия препаратом ТИБСОВО<span className="text-[28px] md:text-[40px]">®</span> характеризуется удовлетворительной переносимостью. <br />
              Профиль безопасности ТИБСОВО<span className="text-[28px] md:text-[40px]">®</span> хорошо изучен
            </h3>
...
одной линии системной терапии:`}
        ...
        >
          <button 
            ...
            style={{ fontSize: '16px', color: '#FFF', fontWeight: 600, lineHeight: 1.4 }}
          >
