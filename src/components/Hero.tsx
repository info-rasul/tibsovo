    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1360px] pl-5 pr-5 pt-[100px] pb-10 lg:pl-10 lg:pr-10 lg:pt-[127px] 2xl:px-0 overflow-y-auto">
        ...
        <div className="flex flex-col items-start gap-8 max-w-[911px]">
          <h1 className="text-[#61279E] text-4xl md:text-[64px] font-semibold leading-[110%] tracking-[-2.56px]">
            ТИБСОВО<span className="text-[64px]">®</span>: индивидуальный подход для наилучшего результата
          </h1>
          
          <p className="text-[#151518] text-xl font-normal leading-[140%] max-w-[675px] pr-5">
            ТИБСОВО<span className="text-[20px]">®</span> является единственным препаратом таргетной терапии, направленной на mIDH1, который включен в клинические рекомендации ESMO (I-A) и NCCN (категория 1) для пациентов с холангиокарциномой с мутацией в гене IDH1.
          </p>
        </div>
        ...
        <div className="mt-10 lg:mt-[89px] flex flex-col gap-2 max-w-[448px]">
          ...
          <div className="relative rounded-[20px] bg-[rgba(224,219,244,0.4)] p-5 md:p-6 flex flex-col justify-center items-start gap-3">
            <div className="text-[#61279E] text-[44px] font-semibold leading-[110%] tracking-[-1.32px]">
              {stats[0].value}
            </div>
            <div className="text-[#151518] text-base font-normal leading-[140%]">
              {stats[0].description}
            </div>
            {/* Info Icon */}
            <svg 
